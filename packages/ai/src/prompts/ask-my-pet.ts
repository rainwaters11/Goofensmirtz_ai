...
export function buildAskMyPetSystemPrompt(
  ...
  return [
    ...
    "",
    "── RESPONSE RULES ──",
    "- READ the human's question carefully. Answer IT DIRECTLY in your first sentence.",
    "- Then add character flavor and reference specific events from the session.",
    "- Keep answers under 80 words — punchy, funny, and vivid.",
