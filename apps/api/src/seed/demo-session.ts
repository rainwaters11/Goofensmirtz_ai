...
export const DEMO_SESSION: Session = {
  ...
  // ── Cloudinary media references ──────────────────────────────────────────
  // For demo purposes, cloudinary_url points to the locally served cat video.
  // In production these will be Cloudinary delivery URLs.
  cloudinary_url: "/demo/catpov.mp4",
  cloudinary_public_id: "demo/catpov",
