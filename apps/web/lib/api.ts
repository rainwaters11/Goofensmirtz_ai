...
/**
 * Fetch the full list of available narration personas from GET /api/personas.
 * Used by PersonaSelector and the settings page.
 */
...
export interface AskPetResponse {
  response: string;
  personaName: string;
  /** TTS audio URL for the response, if generated server-side. Null otherwise. */
